(ns marketentry.store
  "SSoT for the ETH market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems ET" :portal "e-GP/FPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-et-entity? true :has-et-entity? true
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ETH" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-GP/FPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-et-entity? true :has-et-entity? true
             :requires-tin? true :tin-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-GP/FPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ETH" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-GP/FPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-et-entity? true :has-et-entity? false
             :requires-tin? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ETH" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-GP/FPPA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-et-entity? true :has-et-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "ETH" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-GP/FPPA"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-et-entity? has-et-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-et-entity?)  (assoc :engagement/requires-et-entity? requires-et-entity?)
    (some? has-et-entity?)       (assoc :engagement/has-et-entity? has-et-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-et-entity? :engagement/has-et-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-et-entity? (boolean (:engagement/requires-et-entity? m))
     :has-et-entity? (boolean (:engagement/has-et-entity? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-eth"})
