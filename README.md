# cloud-itonami-iso3166-eth

Open ISO 3166 Blueprint for **ETH**: Ethiopia.
...
tax registration, and local-content rules in Ethiopia, so the operator
...
- **Not the government of Ethiopia.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Ethiopian-licensed counsel
...
(ISO 3166 `ETH`). Required capabilities:
